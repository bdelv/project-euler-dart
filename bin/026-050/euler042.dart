...
List<int> listTn =
    List<int>.generate(50, (int idx) => idx * (idx + 1) ~/ 2, growable: false);

int wordValue(String word) {
  int res = 0;
  res = word.split('').fold<int>(
      0,
      (previousValue, element) =>
          previousValue + element.codeUnitAt(0) - 'A'.codeUnitAt(0) + 1);
  return res;
}

bool isTriangleWord(String word) {
  return listTn.contains(wordValue(word));
}
